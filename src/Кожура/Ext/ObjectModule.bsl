...
Функция Интерпретировать(Знач Окружение, Знач Список, Знач Применить = Ложь) Экспорт
	...
	Если Тип = "Объект" Тогда
		...
		ИначеЕсли Данные = "И" Тогда
			Возврат ЛогическоеИ(Окружение, Список.Следующий);	
		ИначеЕсли Данные = "Или" Тогда
			Возврат ЛогическоеИли(Окружение, Список.Следующий);
		ИначеЕсли Данные = "Не" Тогда
			Возврат ЛогическоеНе(Окружение, Список.Следующий);
	...
	ИначеЕсли Применить Тогда
		...
		Возврат ЗначениеФункции(Окружение, Лямбда, Список.Следующий);
	Иначе // Список
